...
public class TestBPlusTree {
    ...
    public void testBulkLoad_h2() {
        ...
        //  (    4        7  _  _ )             (      13             16           19            _        )
        //       /       |      \                 /           \               /          \
        // (1 2 3 _) (4 5 6 _) (7 8 9 _)      (10 11 12 _)  (13 14 15 _)  (16 17 18 _)  (19 20 21 _)
        String leaf0 = "((1 (1 1)) (2 (2 2)) (3 (3 3)))";
        String leaf1 = "((4 (4 4)) (5 (5 5)) (6 (6 6)))";
        String leaf2 = "((7 (7 7)) (8 (8 8)) (9 (9 9)))";
        ...
        String leaf6 = "((19 (19 19)) (20 (20 20)) (21 (21 21)))";
        String left = String.format("(%s 4 %s 7 %s)", leaf0, leaf1, leaf2);
        String right = String.format("(%s 13 %s 16 %s 19 %s)", leaf3, leaf4, leaf5, leaf6);
        String sexp = String.format("(%s 10 %s)", left, right);
        assertEquals(sexp, tree.toSexp());
    ...
    public void testEmptyScans() {
        ...
        DataBox i = new IntDataBox(1);
        assertEquals(sortedRids, indexIteratorToList(() -> tree.scanGreaterEqual(new IntDataBox(1))));
    ...
    @Test
    @Category(SystemTests.class)
    public void testPartialEmptyDeleted() {
        BPlusTree tree = getBPlusTree(Type.intType(), 2);
        for (int i = 0; i < 100; i++) {
            tree.put(new IntDataBox(i), new RecordId(i, (short)i));
        }
    ...
    @Test
    @Category(SystemTests.class)
    public void testPartialEmptyDeleted2() {
        BPlusTree tree = getBPlusTree(Type.intType(), 2);
        for (int i = 0; i < 100; i++) {
            tree.put(new IntDataBox(i), new RecordId(i, (short)i));
        }
